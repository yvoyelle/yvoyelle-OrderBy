    ...
    public void problem2() {
        try {
            ...
            try {
                ...
                Assert.fail("There was an issue with your SQL statement in lab3.sql:"+e.getMessage());
            }
            Assert.assertEquals(expectedList, resultList);
        }catch(Exception e) {
            Assert.fail("There was an issue running the test in lab3.sql: "+e.getStackTrace());
        }
    }
